...
export default function MilhoColetaPage() {
  ...
  return (
    <div className="container mx-auto py-8">
      <Card>
        <CardHeader>
          <CardTitle>🌽 Coleta de Dados - Milho</CardTitle>
          <CardDescription>
            Registre as informações da sua lavoura de milho
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="Transgênico">Transgênico</SelectItem>
